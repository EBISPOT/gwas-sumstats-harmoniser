...
{
   printf ""
   printf "Usage: $0 -r reference -c count -d removed -h harmonized -q qc -s script -o output\n"
   ...
   printf "\t-q Harmaonization result after qc\n"
   printf "\t-s python script for counting\n"
